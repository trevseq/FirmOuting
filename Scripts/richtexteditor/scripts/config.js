...
window.RTE_Configuration =
{
	...
	toolbar		    :	"ribbon",//auto configures the toolbar with a set of buttons
	...
	showrulers	    :	true,//specifies whether to display horizontal and/or vertical rulers 
	...
	showresizecorner:	false,//specifies whether to display the resize handle at the corner of the editor	
	...
	toolbars	:	
	{
		...
		"none": "",
		"customRibbon": "<@COMMON,ribbonpaste,pastetext,pasteword,{save,new,print,spellcheck}{cut,copy,delete,find}{undo,redo|formatpainter}><@FORMAT,[fontname,fontsize]{bold,italic,underlinemenu|forecolor,backcolor}{superscript,subscript,changecase|removeformat,cleancode,selectall}><@PARAGRAPHS,[paragraphs,styles]{justifymenu,lineheight,ltr,rtl,insertlinemenu}{insertorderedlist,insertunorderedlist,outdent,indent,insertblockquote}><@INSERT,ribbontable,insertgallery,insertimage,{toggleborder,help}{insertlink,unlink,insertdate,insertchars,virtualkeyboard}{inserttemplate,insertdocument,insertvideo,insertyoutube,googlemap}>",
	},
